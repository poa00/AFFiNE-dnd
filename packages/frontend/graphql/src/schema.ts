...
export interface BlobQuotaExceededDataType {
  __typename?: 'BlobQuotaExceededDataType';
...
export enum Errors {
  ...
  BlobQuotaExceeded = 'BlobQuotaExceeded',
  ...
  SubscriptionRecurringExists = 'SubscriptionRecurringExists',
  UserNotFound = 'UserNotFound',
  VersionRejected = 'VersionRejected',
  WorkspaceNotFound = 'WorkspaceNotFound',
  WrongSignInCredentials = 'WrongSignInCredentials',
  WrongSignInMethod = 'WrongSignInMethod',
}
...
export interface MemberQuotaExceededDataType {
  __typename?: 'MemberQuotaExceededDataType';
  limit: Scalars['Int']['output'];
}
...
export interface Mutation {
  ...
  /** Cleanup sessions */
  cleanupCopilotSession: Scalars['String']['output'];
...
export interface SubscriptionRecurringExistsDataType {
  __typename?: 'SubscriptionRecurringExistsDataType';
  recurring: Scalars['String']['output'];
}
